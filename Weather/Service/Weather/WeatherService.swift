...
struct WeatherService {
    func getWeather(latitude: String, longitude: String) async throws -> WeatherDataModel? {
        if let url = URL(string: "https://api.open-meteo.com/v1/forecast?current=temperature_2m,weather_code&daily=temperature_2m_min,temperature_2m_max,weather_code,sunrise,sunset,precipitation_probability_mean,precipitation_sum,uv_index_max&timezone=auto&latitude=\(latitude)&longitude=\(longitude)&forecast_days=7&temperature_unit=celsius&hourly=temperature_2m,precipitation_probability,weather_code") {
